...
import Digimitrregistration from "./Pages/Digimitrregistration";
import Vlelogin from "./Pages/Vlelogin";
import Retailer_dashboard from "./Pages/RetailerDashboard/Retailer_dashboard";
import Retailerservice from "./Pages/RetailerDashboard/Retailerservice";
import Dashboard_retailer from "./Pages/RetailerDashboard/Dashboard_retailer";
import Retailer_aeps_srvs from "./Pages/RetailerDashboard/Retailer_aeps_srvs";
const App = () => {
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/Digi-mitr-registration"
          element={<Digimitrregistration />}
        />
        <Route path="/Vle-Login" element={<Vlelogin />} />
        <Route path="/login" element={<LoginForm setUser={setUser} />} />
        <Route
          path="/loginUserPannel"
        ...
        />
        <Route
          path="/initialtestStart"
          element={
            user ? <Initialtemplates user={user} /> : <Navigate to="/login" />
          }
        />
        <Route
        ...
        />
        <Route
          path="/userPannel-assesments"
          element={
            user ? (
              <Assesment user={user} assesmentUser={assesmentUser} />
            ) : (
              <Navigate to="/login" />
            )
          }
        ...
        <Route
          ...
          element={<DigitalMitraEnrollment />}
        />

        {/* Retailer Dashboar Section Routes */}

        <Route path="/Retailer-dashboard" element={<Retailer_dashboard />} />
        <Route path="/Retailer-service" element={<Retailerservice />} />
        <Route path="/retailer_aeps_srvs" element={<Retailer_aeps_srvs />} />
     </Routes>
    </Router>
  );
};
